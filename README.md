...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-aw8tvjq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-aw8tvjq.containers.anotherwebservice.com/
...
```
git clone git@github.com:crispymanya/container-aw8tvjq.git
cd container-aw8tvjq
```
...
```
docker attach container-aw8tvjq
```
